	...
	return function(e) {
		...
		var y = function(e) {
			...
			return s(t, e), a(t, [{
				...
				value: function() {
					...
					/*fuxin 2017-7*/
					(0, f.addEvent)(this.confirmInpt_s, "blur", function() {
						$('.begintime').addClass("orangecs");
						for(var t = !1, i = 0; i < e.data.length; i++) {
							var n = e.wheels[i].getSelectedIndex();
							e.selectedIndex[i] = n;
							var r = null;
						...
						e.trigger("picker.begintime", e.selectedVal, e.selectedIndex), t && e.trigger("picker.valuechange", e.selectedVal, e.selectedIndex)
					}),
					(0, f.addEvent)(this.confirmInpt_e, "blur", function() {
						$('.endstime').addClass("orangecs");
						for(var t = !1, i = 0; i < e.data.length; i++) {
							var n = e.wheels[i].getSelectedIndex();
							e.selectedIndex[i] = n;
							var r = null;
						...
						e.trigger("picker.endstime", e.selectedVal, e.selectedIndex), t && e.trigger("picker.valuechange", e.selectedVal, e.selectedIndex)
					})
					/*fuxin 2017-7 end*/
				}
			}, {
				...
				t.BScroll = function(e) {
					...
					return o(t, e), s(t, [{
						...
						value: function(e) {
							...
							function whichfocs() {
								var begintimetxt = $(".begintime"),
									endstimetxt = $(".endstime");
								if(begintimetxt.is(":focus")) {
									begintimetxt.addClass("orangecs").val(first[selectedIndex[0]].text + ' ' + second[selectedIndex[1]].text + ' ' + third[selectedIndex[2]].text)
								}
								if(endstimetxt.is(":focus")) {
									endstimetxt.addClass("orangecs").val(first[selectedIndex[0]].text + ' ' + second[selectedIndex[1]].text + ' ' + third[selectedIndex[2]].text)
								}
							}
							/*fuxin 2017-7 end*/
						}
		...
		e.exports = (n.default || n).template(function(e, t, i, n, r) {
			...
			return h += '<div class="picker">\n  <div class="picker-mask mask-hook"></div>\n  <div class="picker-panel panel-hook">\n    <div class="picker-choose choose-hook">\n      <span class="cancel cancel-hook">取消</span>\n      <span class="confirm confirm-hook">确定</span>\n      <h1 class="picker-title">', (l = i.title) ? a = l.call(t, {
				...
				hash: {},
				data: r
			}) : l), h += p(a) + '</h1>\n    </div>\n  <div class="PartsTime"><div class="inputimebox"><p></p></div><div class="inputimebox"><input class="begintime" id="begintime" name="begintime" type="text" placeholder="开始时间" readonly value=""></div><div class="inputimebox"><span>至</span></div><div class="inputimebox"><input class="endstime" name="endstime" type="text" placeholder="结束时间" readonly value=""></div><div class="inputimebox"><p class="emptytime"><img src="images/trash.png"></p></div></div>\n  <div class="picker-content">\n      <div class="mask-top border-1px"></div>\n      <div class="mask-bottom border-1px"></div>\n      <div class="wheel-wrapper wheel-wrapper-hook">\n        ', a = i.each.call(t, t && t.data, {
				hash: {},
				inverse: u.noop,
				fn: u.program(1, o, r),
				data: r
